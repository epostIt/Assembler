            ...
            while parser.has_more_instructions():
                ...
                if inst_type == parser.A_INSTRUCTION:
                    try:
                        ...
                        logging.error("There was an error with an A type instruction on line " + str(lineNumber))
                    ...
                    try:
                        ...
                        logging.error("There was an error with an C type instruction on line " + str(lineNumber))
                        hack_file.write("There was an error with this instruction \n")
                elif inst_type == parser.L_INSTRUCTION:
                    pass
